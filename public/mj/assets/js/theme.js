    ...
    initGoogleMap: function() {
      ...
      function initialize() {
        var mapOptions = {
          scrollwheel: false,
          zoom: 16,
          center: new google.maps.LatLng(3.162307, 101.711869) // map coordinates
        };
        map = new google.maps.Map(document.getElementById('map-canvas'),
          mapOptions);
        marker = new google.maps.Marker({
          position: new google.maps.LatLng(3.162307, 101.711869), // marker coordinates
          map: map,
          icon: image,
          title: 'Hello World!'
        });
